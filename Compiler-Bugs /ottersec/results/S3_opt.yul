    ...
    code {
        {
            ...
            codecopy(_1, dataoffset("S3_289_deployed"), datasize("S3_289_deployed"))
            return(_1, datasize("S3_289_deployed"))
        }
    ...
    object "S3_289_deployed" {
        code {
            ...
            function fun_trigger() -> var
            {
                ...
                let expr_1 := fun_add(expr, convert_t_rational_by_to_t_uint256(0x02))
                var := fun_empty1(expr_1, fun_change())
            }
        }
        data ".metadata" hex"a26469706673582212206684b5162f1dd2d4e67ce9d12f5ee018a90811e581f854ba9c1eb3fe7671bb5664736f6c63430008150033"
    }
}

...
object "S2_227" {
    code {
        {
            ...
            codecopy(_1, dataoffset("S2_227_deployed"), datasize("S2_227_deployed"))
            return(_1, datasize("S2_227_deployed"))
        }
    ...
    object "S2_227_deployed" {
        code {
            ...
            {
                var := zero_value_for_split_uint256()
                var := fun_empty1(var_a, fun_change())
            }
            ...
            function fun_trigger() -> var_
            {
                ...
                var_ := fun_empty(read_from_storage_split_offset_uint256(0x00))
            }
        }
        data ".metadata" hex"a26469706673582212202d807502e892d82ce4bbdd520722b15a28f6e4079450890767b0149ebf186dcf64736f6c63430008150033"
    }
}
